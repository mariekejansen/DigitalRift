...
const contractABI = require("../artifacts/contracts/Digitalrift.sol/Digitalrift.json").abi;

program
    .name("digitalrift-cli")
    .description("CLI tool for Digitalrift smart contract")
    .version("1.0.0");
