 ...
 * This file demonstrates how to integrate Digitalrift with a web frontend
 */

// For React/Vue/Angular applications
export class DigitalriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DigitalriftClient(provider, contractAddress);
